...
• Phân tích rủi ro khi kẻ tấn công chạm trực tiếp vào thiết bị.
• Tìm hiểu cổng debug, bộ nhớ, reset, secure element ở mức khái niệm.
• Đề xuất kiểm soát vật lý và phần mềm.
---
